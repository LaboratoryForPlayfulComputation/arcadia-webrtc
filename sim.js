...
(function (pxsim) {
    ...
    var Board = /** @class */ (function (_super) {
        ...
        function Board() {
            ...
            _this.font = pxsim.three.parseFont(font.helvetiker_regular);
            /* AR */
            _this.markers = {};
            _this.markerColors = [0xff0000, 0xff4c00, 0xffe100, 0x33b500,
                0x00660a, 0x00e082, 0x00e0ba, 0x006ee5,
                0x0003e5, 0x4200a5, 0x6600ff, 0xe500ff,
                0xff00a5, 0x822600, 0x000000, 0xffffff];
            _this.renderer = getWebGlContext();
            //this.stereoRenderer   = getStereoRenderer();
            _this.mirror = false;
            _this.vrEffect = false;
            _this.camera = pxsim.three.createCamera();
            _this.scene = pxsim.three.createScene();
